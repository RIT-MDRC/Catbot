...
# Number of bits of resolution in our ADC. The one on Catbot's peripheral board has 12 bits,
# but this can be reassigned if testing on an Arduino with less resolution (like the Leonardo)
